    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-6 pt-20 transition-all duration-300">
      ...
      >
        <div className="p-6 border-b border-gray-100">
          <h2 className="text-2xl font-bold text-gray-800">سجلات القراءة</h2>
        </div>
          ...
          <table className="w-full">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-6 py-4 text-right text-sm font-semibold text-gray-600">مدة القراءة</th>
                <th className="px-6 py-4 text-right text-sm font-semibold text-gray-600">آخر فتح</th>
                <th className="px-6 py-4 text-right text-sm font-semibold text-gray-600">إجمالي القراءات</th>
              </tr>
            </thead>
            <tbody>
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center">
                      ...
                      <span className="text-gray-700">{record.user}</span>
                    </div>
                  </td>
                  <td className="px-6 py-4">
                    <div className="flex items-center">
                      <Clock className="w-5 h-5 text-gray-400 mr-3" />
                      <span className="text-gray-700">{record.duration} دقيقة</span>
                    </div>
                  </td>
                  <td className="px-6 py-4">
                    <div className="flex items-center">
        ...
        {filteredRecords.length === 0 && (
          <div className="text-center py-16">
            ...
            <h3 className="text-xl font-semibold text-gray-600 mb-2">لا توجد سجلات قراءة</h3>
