      ...
      >
        <div className="flex items-center justify-between mb-8">
          ...
          <motion.button
            ...
            className="bg-gradient-to-r from-blue-500 to-purple-600 text-white px-8 py-4 rounded-xl hover:shadow-xl transition-all duration-300 flex items-center font-semibold"
          >
