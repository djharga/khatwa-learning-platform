...
const PremiumSection = ({ questions, onQuizComplete, isSubscribed = false }: PremiumSectionProps) => {
  ...
  if (showQuiz && selectedQuestions.length > 0) {
    ...
    return (
      ...
      >
        <div className="bg-gradient-to-r from-purple-50 via-indigo-50 to-pink-50 dark:from-purple-900/20 dark:via-indigo-900/20 dark:to-pink-900/20 rounded-2xl shadow-xl p-6 mb-6 border border-purple-200 dark:border-purple-800">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
              ...
              <p className="text-purple-700 dark:text-purple-300">{config.description}</p>
            </div>
            <motion.button
              onClick={() => {
                setShowQuiz(false);
              ...
              className="bg-gray-600 hover:bg-gray-700 dark:bg-neutral-700 dark:hover:bg-neutral-600 text-white px-6 py-3 rounded-xl font-semibold transition-colors shadow-md hover:shadow-lg"
    ...
    >
      ...
      <div className="text-center mb-8">
        <motion.div
          initial={{ scale: 0.9 }}
          animate={{ scale: 1 }}
          className="inline-flex items-center gap-3 bg-gradient-to-r from-purple-100 via-indigo-100 to-pink-100 dark:from-purple-900/30 dark:via-indigo-900/30 dark:to-pink-900/30 px-6 py-3 rounded-full mb-6 shadow-lg"
        >
          <Crown className="w-6 h-6 text-purple-600 dark:text-purple-400" />
          <span className="text-purple-700 dark:text-purple-300 font-bold text-lg">الأسئلة المميزة</span>
