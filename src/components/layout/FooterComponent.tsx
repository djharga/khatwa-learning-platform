      ...
      <div className="flex gap-2 pt-4">
        {socialLinks.map((social, index) => {
          ...
          return (
            ...
            >
              <IconComponent className="w-5 h-5 text-gray-300 hover:text-white transition-colors" aria-hidden="true" />
            </a>
          );
        })}
      </div>
        ...
        <div className="flex flex-col sm:flex-row gap-3 max-w-lg mx-auto">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pr-10 pl-4 py-3 bg-white/5 border border-white/10 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all"
          ...
          <button
            ...
            className="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center justify-center gap-2 min-h-[44px]"
