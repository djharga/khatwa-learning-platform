    ...
    >
      ...
      <div className="flex flex-wrap gap-3 pt-2">
        {[
          ...
          const hoverBgColor = index === 0 ? 'hover:bg-yellow-500/30' : index === 1 ? 'hover:bg-green-500/30' : 'hover:bg-blue-500/30';
          return (
            <MotionWrapper
              key={index}
              animation="scale"
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="relative bg-gradient-to-r from-primary-500/10 via-purple-500/10 to-blue-500/10 backdrop-blur-md rounded-2xl p-8 border border-white/10 hover:border-white/20 transition-all duration-300 shadow-elevation-4 hover:shadow-elevation-5 overflow-hidden group hover-glow-primary-sm">
          ...
          <div className="relative z-10 text-center space-y-6">
            ...
            {/* Email Input */}
            <MotionWrapper animation="slideDown" delay={0.7} duration={0.5} className="flex flex-col sm:flex-row gap-3 max-w-lg mx-auto">
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="flex flex-col lg:flex-row justify-between items-center gap-4">
          {/* Copyright */}
          <MotionWrapper animation="slide" delay={0.6} duration={0.5} className="text-neutral-300 text-sm text-center lg:text-right">
            <p>
              © {currentYear} <span 
                ...
                dir="rtl"
              >خطى التعليمية</span>. جميع الحقوق محفوظة.
            </p>
          </MotionWrapper>
