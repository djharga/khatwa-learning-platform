...
// Icon mapping for QuickAccess - matches AppSidebar iconMap
const iconMap: Record<string, React.ComponentType<{ className?: string; size?: string | number }>> = {
  ...
  learning: BookOpen,
  instructor: Users,
  'course-tree': LibraryBig,
  services: Settings,
  community: Users,
  resources: LibraryBig,
  'resource-course-files': LibraryBig,
  'course-files': LibraryBig,
