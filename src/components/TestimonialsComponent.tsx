...
const TestimonialCard: React.FC<TestimonialCardProps> = ({ testimonial, index }) => (
  <motion.div
    ...
    viewport={{ once: true }}
    className="group relative overflow-hidden rounded-3xl border border-purple-100/60 bg-white/80 p-8 shadow-xl transition-all duration-500 hover:-translate-y-3 hover:bg-white hover:shadow-2xl"
  >
...
const HighlightStatCard: React.FC<HighlightStatCardProps> = ({ stat }) => (
  <div
    key={stat.label}
    className="group relative overflow-hidden rounded-3xl border border-purple-100/60 bg-white/80 px-8 py-6 shadow-lg transition-all duration-300 hover:-translate-y-1 hover:bg-white"
  >
...
const TestimonialsComponent = () => {
  return (
    <section
      className="relative py-20 px-6 sm:px-8 lg:px-12 bg-gradient-to-br from-slate-50 via-purple-50/30 to-slate-100 overflow-hidden parallax-slow"
      id="testimonials"
    >
      {/* Enhanced decorative elements with subtle parallax */}
      <div className="absolute inset-0 opacity-30">
        <div className="absolute top-10 left-10 w-32 h-32 bg-gradient-to-br from-blue-200/20 to-purple-200/20 rounded-full blur-xl parallax-medium"></div>
        <div className="absolute bottom-20 right-20 w-40 h-40 bg-gradient-to-br from-purple-200/20 to-indigo-200/20 rounded-full blur-xl parallax-fast"></div>
      </div>
      ...
      <div className="relative grid-container">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="mb-14 flex flex-col sm:flex-row items-center justify-center gap-6"
        >
