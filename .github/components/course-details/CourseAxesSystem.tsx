                          ...
                          return (
                            <div key={subAxis.id} className="border-b border-neutral-200 dark:border-neutral-700 last:border-b-0">
                              <div className="flex items-center gap-2">
                                ...
                                {/* زر الانتقال إلى صفحة الدروس */}
                                {(courseSlug || courseId) && (
                                  <motion.button
                                    onClick={(e) => {
                                      e.stopPropagation();
                                      // استخدام slug إذا كان متاحاً، وإلا استخدام courseId
                                      if (courseSlug) {
                                    ...
                                    whileTap={{ scale: 0.95 }}
                                    className="flex items-center gap-2 px-4 py-2 bg-primary-600 hover:bg-primary-700 text-white rounded-lg transition-colors text-sm font-medium shadow-sm hover:shadow-md"
