...
import { 
  ...
  ShoppingBag, MoreHorizontal, LogIn, UserPlus, 
...
const navigationItems = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'المراجعة الداخلية', href: ROUTES.INTERNAL_AUDIT },
      { label: 'المحاسبة المالية', href: '/courses/financial-accounting' },
    ],
  },
  {
    label: 'CIA',
    ...
    icon: Award,
    children: [
      { label: 'نظرة عامة', href: `${ROUTES.CIA}?tab=overview` },
      { label: 'الموارد', href: `${ROUTES.CIA}?tab=resources` },
      { label: 'بنك الأسئلة', href: `${ROUTES.CIA}?tab=questions` },
    ],
  },
  {
    label: 'الاستشارات',
  ...
  },
  {
    ...
    icon: MoreHorizontal,
    children: [
      { label: 'الأدوات الذكية', href: ROUTES.AI_TOOLS },
      { label: 'المجتمع', href: '/community' },
      { label: 'المدونة', href: ROUTES.BLOG },
