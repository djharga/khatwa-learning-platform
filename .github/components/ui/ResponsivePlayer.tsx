 ...
 * مكون فيديو متجاوب يحافظ على نسبة 16:9 دائماً
 * متوافق مع RTL و LTR
 * 
 * @example
 * ```tsx
...
export function ResponsivePlayer({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        'w-full max-w-4xl mx-auto', // مركزي مع max-width
    ...
    >
      {/* Container with 16:9 aspect ratio using Tailwind aspect-video */}
      <div
        className={cn(
      ...
      >
        ...
        {controls && (
          ...
          >
            ...
            {title && (
              <div 
                className="absolute top-0 left-0 right-0 bg-gradient-to-b from-black/60 to-transparent p-4 pointer-events-none"
                style={{
                  textAlign: 'inherit', // يرث text-align
                }}
              >
            ...
            {/* Controls Bar */}
            <div 
              className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 via-black/60 to-transparent p-3 sm:p-4 pointer-events-auto"
              style={{
                direction: 'inherit', // يرث direction
              }}
            >
