      ...
      <Container size="xl" className="relative z-10">
        ...
        <ScrollAnimation direction="up" delay={0.1}>
          <div className="text-center mb-12 mt-4" dir="rtl">
            <h2 
              className="text-3xl md:text-4xl font-black mb-4 bg-gradient-to-r from-primary-600 to-academic-accent-600 bg-clip-text text-transparent"
              style={{
            ...
            <AnimatePresence mode="wait">
              ...
              >
                {featuredCourses[currentIndex] && (
                  <GlassCard variant="elevated" size="lg" className="grid lg:grid-cols-2 gap-8 items-center justify-center p-8 lg:p-14">
